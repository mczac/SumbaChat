...
final class CachingSettingsViewController: UITableViewController, UITextFieldDelegate {
    ...
    private let colorThumbs = UIColor.systemGray
    private let colorPreviews = UIColor.systemGray2
    ...
    private lazy var cacheLimitAccessory: UIStackView = {
        ...
        cacheLimitField.widthAnchor.constraint(greaterThanOrEqualToConstant: 72).isActive = true
        cacheLimitField.widthAnchor.constraint(lessThanOrEqualToConstant: 120).isActive = true

        let stack = UIStackView(arrangedSubviews: [cacheLimitField, mbLabel])
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .overview:
            ...
            cell.configure(
                ...
                otherItems: [
                    ...
                    CacheUsageItem(title: NSLocalizedString("Convert", comment: "Legend: convert cache"), bytes: convertBytes, color: colorConvert),
        ...
        case .chatCache:
            ...
            case .cacheLimit:
                ...
                cell.accessoryView = cacheLimitAccessory
        ...
        case .otherStorage:
            ...
            case .convertCache:
                config.text = NSLocalizedString("Convert cache", comment: "")
                config.secondaryText = String.localizedStringWithFormat(
                    NSLocalizedString("%@ · soft cap %@", comment: "Size and soft cap"),
        ...
        case .chatCache:
            ...
            case .videos:
                return ClearSpec(
                    ...
                    message: NSLocalizedString(
                        "Removes downloaded video attachments only. Encoded reuse is under Convert cache.",
                        comment: ""
                    )
                ) { [weak self] in
